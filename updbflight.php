...
if($mysql->connect_error)
{
	...
	$sql2 = "INSERT INTO transaction(Sender_Mobile,Service,Amount,Balance) values('$mobile','Flight','$num','$total')";		
	...
	$query="SELECT * from services where Service_Name='Flight'";
	...
	$sql3 = "UPDATE services set Amount='$a' where Service_Name='Flight'";
